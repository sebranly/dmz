...
const questionsAnswers: QuestionAnswer[] = [
  ...
  },
  {
    ...
    answer: `I don't have a definite list yet but I noticed that some items you exfiltrate with (or that you drop into dead drops) will be converted into money. For instance a self-revive kit is worth $${formatMoney(
      SELF_REVIVE_KIT_VALUE
    )}.`
  },
  {
